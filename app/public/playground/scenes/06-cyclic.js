...
(function () {
  ...
  function update() {
    ...
    cycLab.setAttribute('x', cx + Math.cos(pc.a) * (R + 40));
    cycLab.setAttribute('y', cy + Math.sin(pc.a) * (R + 40) + 3);
    nextLab.setAttribute('x', cx + Math.cos(pn.a) * (R + 32));
    nextLab.setAttribute('y', cy + Math.sin(pn.a) * (R + 32) + 3);
